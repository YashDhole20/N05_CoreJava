...
public class StreamFunction {
	...
	//Remove all empty Strings from list
	public static List<String> nonEmptyStringList(Stream<String> stream,int n){
		
		List<String> filterList=stream.filter(x->x.length()>n).collect(Collectors.toList());
		return filterList;
	}
	...
	public static void showStatistics(Stream<Integer> stream) {
		...
		System.out.println("Average of all Numvers :"+stats.getAverage());
	}
}
